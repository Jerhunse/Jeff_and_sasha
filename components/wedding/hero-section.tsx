    ...
    <section className="relative w-full">
      ...
      <div className="container py-16">
        <div className="text-center mb-8">
          <h2 className="font-cursive text-4xl text-gold mb-2">Counting Down</h2>
          <p className="text-muted-foreground">Until we say &ldquo;I do&rdquo;</p>
        </div>
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center">
          <div className="container px-4">
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
              <h1 className="font-cursive text-6xl md:text-8xl font-semibold mb-6 text-foreground drop-shadow-lg">
