  ...
  try {
    ...
    const events = [
      ...
      },
      {
        ...
        endTime: new Date(`${baseDate}T20:00:00-04:00`),
        location: 'The Venue at Stillwater Pond',
        address: '175 Pollard Rd, Temple, GA 30179',
        visibility: 'PUBLIC' as const,
        order: 6,
      ...
      {
        name: 'Fake Sendoff',
        description: 'A fun sendoff for photos! Then we head back inside to keep the party going.',
        startTime: new Date(`${baseDate}T20:00:00-04:00`),
        endTime: new Date(`${baseDate}T20:15:00-04:00`),
        location: 'The Venue at Stillwater Pond',
        address: '175 Pollard Rd, Temple, GA 30179',
        visibility: 'PUBLIC' as const,
        order: 7,
      ...
      {
        name: 'Official Venue Exit',
        description: 'Please exit the venue by 10 PM. The 8 PM sendoff was for photos—the party continues until 10!',
